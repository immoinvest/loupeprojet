...
- **Prochaine étape (session principale)** : `marche-complet` (loyer visé estimé depuis l'ANIL, DPE ADEME retrouvé par l'adresse pour nourrir l'estimation, risques Géorisques, communes limitrophes dans les cercles). La publication DVF France entière dépend de l'Action « Référentiels ».
