...
- **Prochaine étape (session principale)** : `marche-complet` (loyer visé estimé depuis l'ANIL, DPE ADEME, risques Géorisques, type de bien dans le formulaire, communes limitrophes dans les cercles). La publication DVF France entière dépend de l'Action « Référentiels ».
