...
| E2E web          | Playwright (Chromium : ordinateur, téléphone, tablette ; spec des formats 20 écrans × 9 formats ; build de production servi par `vite preview`) | `apps/web/e2e/`                        |
