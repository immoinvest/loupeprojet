...
| `apps/web`         | Coque SaaS, Mes projets, Nouveau projet (capture, lecture IA, marché de la commune), Rapport, Financement (prêt, lien vers le simulateur), Hypothèses, Fiscalité, Revente, Visite, page Extension, impression, partage par lien, Comparer, Méthode ; responsive de 320 à 1 920 px, application installable et hors ligne (PWA), partage depuis et vers le téléphone | **livré** (PR #3 à #6, #16, #19, #21, `feat/responsive`, `feat/hypotheses-financement`)                        |
