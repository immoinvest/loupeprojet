...
| Module             | Rôle                                                                                                                                                                                                                                                                                                                                                                                           | Statut                                                                                                         |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `packages/moteur`  | Financement, cash-flow, 4 régimes fiscaux, revente, rendement/TRI, verdict, scénarios, estimation du prix et note de confiance (règles datées)                                                                                                                                                                                                                                                 | **livré** (PR `feat/moteur-calcul`, 204 tests, 100 %)                                                          |
| `apps/web`         | Coque SaaS, Mes projets, Nouveau projet (capture, lecture IA, marché de la commune), Rapport, Hypothèses, Fiscalité, Revente, Visite, page Extension, impression, partage par lien, Comparer, Méthode ; responsive de 320 à 1 920 px, application installable et hors ligne (PWA), partage depuis et vers le téléphone ; coque fixe (seul le contenu défile, menu et en-tête de projet en vue) | **livré** (PR #3 à #6, #16, #19, #21, `feat/responsive`, `feat/coque-fixe`)                                    |
...
Tests de bout en bout : `apps/web/e2e/` (Playwright, Chromium) rejoue les parcours utilisateur sur trois appareils (ordinateur, téléphone, tablette) et mesure 16 écrans sur 9 formats, sur le build de production servi par `vite preview`, en local et dans le job CI `e2e` ; voir `architecture/e2e-playwright.md`, `architecture/responsive.md` et `architecture/coque-fixe.md` (menu et en-tête en vue quand le contenu défile).
