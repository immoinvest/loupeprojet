...
| `apps/web`         | Coque SaaS, Mes projets, Nouveau projet, Rapport, Hypothèses, Fiscalité, Revente, Visite, page Extension, impression, partage par lien, Comparer, Méthode | **livré** (PR #3 à #6, #16, #19)                                                    |
