...
| `apps/web`        | Coque SaaS, Mes projets, Nouveau projet (lecture IA, marché de la commune), Rapport, Hypothèses, Fiscalité, Revente, Visite | **livré** (PR #3 à #6, enrichissement-marche) ; Comparer, Méthode, partage à venir  |
