...
├── responsive.spec.ts                19 écrans × 9 formats (16 du responsive, « Estimation sans adresse », 2 du simulateur de prêt) : débordement, cibles, champs, menu, onglet actif, impression A4
...
- **ADR-R7 : preuve en deux étages.** Les parcours tournent sur trois appareils ; une spec « formats » mesure les 19 écrans sur 9 formats (Worker et comptes simulés) dans une seule exécution par format. Écarté : les parcours sur 9 formats (72 tests, trop long pour le job CI).
