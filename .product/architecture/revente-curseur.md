...
- Vérifié dans le navigateur (1 280 px et 375 px) : le centre du pouce, les graduations et les marques des seuils tombent au même pixel pour chaque valeur (couche des seuils bornée par `inset-x-3`, pas par des marges : une couche absolue sans largeur ramenait toutes les marques au bord gauche, ce que jsdom ne voit pas) ; glissement à la souris et flèches écrivent le projet ; téléphone sans débordement, curseur de 44 px en police 16 px ; document imprimable en texte, trois grilles à deux colonnes.
