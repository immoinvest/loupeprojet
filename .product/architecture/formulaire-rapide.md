...
| `apps/web/src/composants/saisie/pas.ts`                                                                  | Pur : `pasAdaptatif`, `lireEntier`, `valeurApresPas`, `bornesAtteintes` (nom distinct de `Compteur.tsx` : Windows ignore la casse)                                                                                                        |
| `apps/web/src/composants/saisie/liste.ts`                                                                | Pur : `indexActifApres(touche, index, total)`, `idsDescription`                                                                                                                                                                           |
...
| `apps/web/src/ecrans/formulaire/Commande.tsx`                                                            | Rendu d'un item (switch) ; `Commandes.tsx` (`Montant`, `OuiNonChamp`, `CompteurChamp`), `contexte.ts` (état et actions passés aux commandes), `ChoixAnnee.tsx`, `ChoixApport.tsx`, `ChoixDuree.tsx`, `ChoixLoyer.tsx`, `ChoixTravaux.tsx` |
