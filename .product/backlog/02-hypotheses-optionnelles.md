...
Statut : `spécifiée` (discovery `../features/hypotheses-optionnelles-discovery.md`, specs `../specs/hypotheses-optionnelles-specs.md`, architecture `../architecture/hypotheses-optionnelles.md`, 14/09/2026) · Notée le 14/09/2026 · Dépend de : 01 (revenus), 04 (travaux) : implémentation après leur fusion
