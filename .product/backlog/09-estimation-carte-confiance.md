...
Statut : `livrée` · Notée le 14/09/2026 · Dépend de : rien
...
- **PR 2 livrée le 14/09/2026** (PR #57, puis correctif de cache PR #60) : la carte géographique des ventes (US-7 et US-8 des specs). Fond de carte : **Plan IGN de la Géoplateforme**, choisi par Pierre le 14/09/2026 (question 3 tranchée). Les CSV DVF portent déjà la latitude et la longitude de chaque vente (question 4 : réglée, aucune republication).
