...
5. **Le rapport** — verdict + cinq feux, puis Financement (onglet : hypothèses du prêt, mensualité, TAEG, coût du crédit, tableau par année, bouton « Simuler un prêt »), Cash-flow, Fiscalité (4 régimes), Revente, Rendement & TRI. Tout modifiable en place, recalcul instantané.
