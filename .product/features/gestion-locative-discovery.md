...
Un second espace de l'application, **« Gérer »**, qui a sa propre section dans le menu, sous la section « Analyser » ; chacune des deux peut être masquée depuis Mon compte (décision de Pierre, 14/09/2026). On y retrouve ses **biens**, ses **locataires** et ses **locations** ; chaque mois, Deklic sait qui a payé, envoie les quittances tout seul et signale ce qui demande une action. Tout le reste (révision du loyer, dépôt de garantie, charges, bilan, déclaration) arrive au bon moment, sous forme de proposition à valider d'un clic.
...
| Feature                    | Livrables                                                                                                                                                                                                                                                                                             |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **G1 `gerer-socle`**       | Sections « Analyser » et « Gérer » du menu, « Mon menu » dans Mon compte ; accueil de Gérer et ses trois portes ; portes « J'ai acheté ce bien » et « Ajouter à la main » ; biens, locataires, locations ; loyers du mois et « Reçu » en un clic ; quittance et reçu en PDF ; données liées au compte |
...
| --- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Connexion bancaire        | **Décidé par Pierre le 14/09/2026** : comme Rentila, par les API bancaires (DSP2, lecture des comptes) ; Deklic se connecte au compte de la personne et détecte le virement du loyer. La banque est le cœur de Gérer : G3 passe juste après le socle. Fournisseur à choisir à l'ADR de G3 ; recommandation : **Enable Banking** pour développer et tester sur les vrais comptes de Pierre sans frais (« production restreinte »), contrat au volume avant l'ouverture au public (dépense à valider alors) ; Powens ou Bridge sur devis en alternative. « Loyer reçu ? » par e-mail reste le repli sans banque |
...
| 3   | Nom et place dans le menu | **Décidé par Pierre le 14/09/2026** : deux sections « Analyser » et « Gérer » dans le même menu, et « Mon menu » dans Mon compte pour masquer l'une ou l'autre (le sélecteur est écarté)                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 4   | Import depuis Rentila     | À tester sur les exports de Pierre ; « Could » de G3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |

## Découpage et ordre

Ordre révisé le 14/09/2026 après la décision sur la banque et l'acceptation de la proposition A (G1 découpée en deux sessions) :

| Ordre | Feature                   | Taille | Dépend de                                         | Ce que l'utilisateur gagne                                                   |
| ----- | ------------------------- | ------ | ------------------------------------------------- | ---------------------------------------------------------------------------- |
| 1     | `gerer-socle` (G1a)       | L      | comptes en service                                | Menu à deux sections ; ses biens et locations en deux clics ; loyers du mois |
| 2     | `banque` (G3)             | L      | G1a ; compte développeur du fournisseur (gratuit) | Connecter sa banque ; virements détectés, loyers marqués reçus tout seuls    |
| 3     | `quittances-fiches` (G1b) | M      | G1a                                               | Quittance et reçu en PDF, fiches bien / locataire / location, colocation     |
| 4     | `quittances-auto` (G2)    | M      | G1b, domaine e-mail vérifié                       | Quittance envoyée au locataire dès que le virement arrive                    |
| 5     | `vie-du-bail` (G4)        | M      | G1b (G2 pour les lettres)                         | Révision, fin de bail, dépôt, charges, alertes                               |
| 6     | `bilan-declaration` (G5)  | M      | G3                                                | Réel vs prévu, déclaration, export                                           |
...
## Revue critique (seconde passe, 14/09/2026)

Faite après la décision de Pierre sur le menu, en relisant les quatre documents avec la question : « qu'est-ce qui ne tient pas la promesse des deux clics, ou contredit ce qui existe déjà ? »

### Corrigé dans cette passe

| #   | Ce qui était écrit                                            | Le problème                                                                                                                           | Correction                                                                                                                                                     |
| --- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Un sélecteur « Analyser · Gérer » qui remplaçait tout le menu | Un mode caché : on passe souvent d'un univers à l'autre (analyser un nouveau bien tout en gérant les autres) ; deux menus à apprendre | Deux sections dans un seul menu ; « Mon menu » dans Mon compte pour masquer l'une ou l'autre (décision de Pierre) ; les biens ne sont plus listés dans le menu |
| 2   | Une barre d'onglets en bas de l'écran au téléphone            | Contredit l'ADR-R1 de `responsive`, livrée entre-temps : le tiroir est la seule navigation, pas de liste de liens en double           | Le tiroir montre les deux sections ; la barre du bas est retirée de l'UX et de la maquette                                                                     |
| 3   | Porte 1 : case « Pas encore loué » puis « C'est parti »       | Trois clics pour un bien vacant, alors que la règle en promet deux                                                                    | « Pas encore loué » devient un second bouton                                                                                                                   |
| 4   | Porte banque : « au retour je choisis les comptes à suivre »  | Une étape et un clic non comptés                                                                                                      | Tous les comptes autorisés sont lus ; un compte se retire ensuite depuis la page Banque                                                                        |
| 5   | « Deux clics » sans définition                                | Chacun pouvait compter à sa façon (une case cochée, un choix dans une liste ?)                                                        | Définition écrite en tête des specs : les boutons qui font avancer comptent, les saisies non ; le compte part de l'utilisateur connecté                        |
| 6   | Un parcours Playwright par porte                              | Le job `e2e` ne sert que le build statique : sans API, ces parcours ne peuvent pas tourner en CI                                      | Exigence ajoutée : l'API des comptes et de la gestion servie pendant le job                                                                                    |
| 7   | Suppression du compte = suppression des données               | Les quittances émises sont des pièces que le bailleur doit garder                                                                     | L'export est proposé avant la suppression                                                                                                                      |
| 8   | Hébergement laissé en question ouverte                        | Le worker Pages n'a pas de déclencheur planifié : sans réponse, G1 ne peut pas démarrer                                               | Recommandation écrite : API dans `apps/comptes`, tâche planifiée dans `apps/worker` sur la même D1 ; ADR au début de G1                                        |
| 9   | Jour du loyer « 5 » par défaut, même depuis la banque         | La banque connaît le vrai jour                                                                                                        | Depuis la banque, le jour observé des virements                                                                                                                |

### À trancher par Pierre

| #   | Proposition                                                                                                                                                                                                  | Pourquoi                                                                                                      | Recommandation                                                                                          |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| A   | Découper G1 (9 stories, taille L) en deux sessions : `gerer-socle` (menu, portes achat et main, échéances, accueil, « Reçu », sécurité) puis `quittances-fiches` (quittance et reçu PDF, fiches, colocation) | Une feature par session ; neuf stories dont quatre M font deux jours de travail, trop pour une session propre | Oui                                                                                                     |
| B   | Une identité de bailleur **par bien** (nom propre ou SCI), avec celle du compte par défaut                                                                                                                   | Le modèle prévoit un seul bailleur par compte ; un investisseur a souvent les deux                            | Oui, petit ajout à G1                                                                                   |
| C   | Notifications sur téléphone pour « Loyer reçu ? » et les retards (l'application est installable depuis la PR #36), e-mail en repli                                                                           | Un toucher au lieu d'un e-mail à ouvrir ; coût nul (Web Push, un Worker)                                      | Oui, P2 de G2                                                                                           |
| D   | Import depuis Rentila comme quatrième porte, réservé au départ à Pierre                                                                                                                                      | Les offres payantes de Rentila ont un export et une API ; si ses fichiers sont lisibles, c'est sa porte à lui | Pierre exporte ses biens, locations et finances depuis Rentila et me les donne ; décision après lecture |
| E   | Alerte « encadrement des loyers » à la création d'une location (Paris, Lyon, Lille, Bordeaux, Montpellier, Bayonne…)                                                                                         | Absent des specs ; risque réel pour le bailleur                                                               | Backlog, dans G4, avec un référentiel des communes encadrées                                            |
| F   | Attestation de loyer pour la CAF, générée depuis la location                                                                                                                                                 | Document souvent demandé par les locataires, absent des specs                                                 | Backlog, après G2                                                                                       |
| G   | Quota d'e-mails : l'offre gratuite de Resend (100 par jour) sature vers trente bailleurs le jour des quittances                                                                                              | Étaler sur plusieurs jours retarde les quittances ; l'offre payante coûte environ 20 $ par mois               | Rien maintenant ; seuil d'alerte dans le journal, décision quand le seuil approche                      |
