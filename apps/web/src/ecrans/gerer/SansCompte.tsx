...
const CLASSE_PRINCIPAL =
  'inline-flex min-h-[44px] items-center justify-center rounded-full bg-accent px-5 text-[15px] font-semibold text-white no-underline survol-plein';
const CLASSE_SECONDAIRE =
  'inline-flex min-h-[44px] items-center justify-center rounded-full border border-bordure bg-surface px-5 text-[15px] font-semibold text-encre-2 no-underline survol-fond';
