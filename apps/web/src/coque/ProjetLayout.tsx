...
export function ProjetLayout(): JSX.Element {
  ...
  const resultats = useMemo(
    () => (enregistre === undefined ? null : calculerProjet(enregistre.projet)),
    [enregistre],
  );

  if (enregistre === undefined || resultats === null) {
    return (
      <div className="p-10">
  ...
  return (
    <Contexte.Provider value={{ enregistre, resultats }}>
      <header className="flex items-end gap-4 border-b border-bordure bg-surface px-10 pt-4">
