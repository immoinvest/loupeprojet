...
/**
 * Section « Gérer » : ajouter un bien, l'accueil et les loyers (avec les loyers en retard). Sans compte,
 * une seule ligne vers la page qui explique pourquoi il en faut un. Les pages Biens, Locataires et
 * Argent y entreront avec leurs features.
 */
      ...
      {etat === 'connecte' ? (
        <>
          ...
          <NavLink to="/gerer/loyers" className={classeLien}>
            ...
            <span className="flex-1">{TEXTES_MENU.loyers}</span>
            {retards > 0 && (
              <span
