...
describe('client : analyse d’adresse', () => {
  it('passe numéro et code de voie quand ils sont connus, et valide la réponse', async () => {
    ...
    expect(f.urls).toEqual([
      'https://worker.test/marche/adresse?codeInsee=13205&lat=43.294813&lon=5.393807&type=appartement&surface=65&numero=144&codeVoie=6659&contrat=7',
      'https://worker.test/marche/adresse?codeInsee=13205&lat=43.294813&lon=5.393807&type=appartement&surface=65&contrat=7',
