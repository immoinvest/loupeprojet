...
describe('Page Méthode', () => {
  it('liste chaque module avec ses formules, ses constantes sourcées et les drapeaux', async () => {
    ...
    expect(within(sommaire).getAllByRole('link')).toHaveLength(13);
    ...
    expect(screen.getAllByText('à confirmer')).toHaveLength(3);
    expect(screen.getByText(/3 valeurs attendent une source officielle/)).toBeInTheDocument();
