...
import { messageInvitation } from '../../courriels/gabarits';
...
import { empreinteEmail, type SignatureJetons } from './jetons';

/*
 * L'accord du locataire (G2-1) et ce que partagent tous les envois : horloge, statut effectif,
 * envoi avec une nouvelle tentative. Les quittances envoyées sont dans `quittances.ts`.
 */
...
export function horodatage(deps: Pick<Dependances, 'maintenant'>): string {
...
export async function statutDe(
...
export async function envoyerAvecTentative(
